...
public class DefaultCodeFormatterConstants {
     ...
     */
    public static final String FORMATTER_ALIGN_TYPE_MEMBERS_ON_COLUMNS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.align_type_members_on_columns";    //$NON-NLS-1$
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_ALLOCATION_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_arguments_in_allocation_expression";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_ENUM_CONSTANT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_arguments_in_enum_constant";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_EXPLICIT_CONSTRUCTOR_CALL = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_arguments_in_explicit_constructor_call";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_METHOD_INVOCATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_arguments_in_method_invocation";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_QUALIFIED_ALLOCATION_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_arguments_in_qualified_allocation_expression";  //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_BINARY_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_binary_expression";        //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_COMPACT_IF = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_compact_if";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_CONDITIONAL_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_conditional_expression";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_ENUM_CONSTANTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_enum_constants";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_EXPRESSIONS_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_expressions_in_array_initializer";  //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_MULTIPLE_FIELDS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_multiple_fields";//$NON-NLS-1$      
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_PARAMETERS_IN_CONSTRUCTOR_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_parameters_in_constructor_declaration";        //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_PARAMETERS_IN_METHOD_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_parameters_in_method_declaration";  //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_SELECTOR_IN_METHOD_INVOCATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_selector_in_method_invocation";        //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_SUPERCLASS_IN_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_superclass_in_type_declaration";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_SUPERINTERFACES_IN_ENUM_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_superinterfaces_in_enum_declaration";    //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_SUPERINTERFACES_IN_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_superinterfaces_in_type_declaration";    //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_THROWS_CLAUSE_IN_CONSTRUCTOR_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_throws_clause_in_constructor_declaration";  //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #createAlignmentValue(boolean, int, int)
     */
    public static final String FORMATTER_ALIGNMENT_FOR_THROWS_CLAUSE_IN_METHOD_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.alignment_for_throws_clause_in_method_declaration";    //$NON-NLS-1$
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_AFTER_IMPORTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_after_imports";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_AFTER_PACKAGE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_after_package";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_AT_BEGINNING_OF_METHOD_BODY = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.number_of_blank_lines_at_beginning_of_method_body"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_BEFORE_FIELD = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_before_field";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_BEFORE_FIRST_CLASS_BODY_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_before_first_class_body_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_BEFORE_IMPORTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_before_imports"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_BEFORE_MEMBER_TYPE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_before_member_type"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_BEFORE_METHOD = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_before_method";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_BEFORE_NEW_CHUNK = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_before_new_chunk";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_BEFORE_PACKAGE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_before_package"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_BLANK_LINES_BETWEEN_TYPE_DECLARATIONS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.blank_lines_between_type_declarations";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_ANNOTATION_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_annotation_type_declaration"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_ANONYMOUS_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_anonymous_type_declaration";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_array_initializer";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_BLOCK = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_block";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_BLOCK_IN_CASE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_block_in_case";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_CONSTRUCTOR_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_constructor_declaration"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_ENUM_CONSTANT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_enum_constant";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_ENUM_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_enum_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_METHOD_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_method_declaration";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_SWITCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_switch";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #NEXT_LINE_ON_WRAP
     */
    public static final String FORMATTER_BRACE_POSITION_FOR_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.brace_position_for_type_declaration";       //$NON-NLS-1$
     ...
     *     - default:           INSERT
     * </pre>
     * @see CoreOptionIDs#INSERT
     * @see CoreOptionIDs#DO_NOT_INSERT
     */     
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_COMPACT_ELSE_IF = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.compact_else_if";       //$NON-NLS-1$
     ...
     * </pre>
     */
    public static final String FORMATTER_CONTINUATION_INDENTATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.continuation_indentation";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_CONTINUATION_INDENTATION_FOR_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.continuation_indentation_for_array_initializer"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_INDENT_BODY_DECLARATIONS_COMPARE_TO_ENUM_CONSTANT_HEADER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indent_body_declarations_compare_to_enum_constant_header";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_INDENT_BODY_DECLARATIONS_COMPARE_TO_ENUM_DECLARATION_HEADER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indent_body_declarations_compare_to_enum_declaration_header";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_INDENT_BODY_DECLARATIONS_COMPARE_TO_TYPE_HEADER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indent_body_declarations_compare_to_type_header";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_INDENT_BREAKS_COMPARE_TO_CASES = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indent_breaks_compare_to_cases"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_INDENT_STATEMENTS_COMPARE_TO_BLOCK = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indent_statements_compare_to_block"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_INDENT_STATEMENTS_COMPARE_TO_BODY = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indent_statements_compare_to_body"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_INDENT_SWITCHSTATEMENTS_COMPARE_TO_CASES = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indent_switchstatements_compare_to_cases";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_INDENT_SWITCHSTATEMENTS_COMPARE_TO_SWITCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indent_switchstatements_compare_to_switch";   //$NON-NLS-1$
     ...
     */
    public static final String FORMATTER_INDENTATION_SIZE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.indentation.size"; //$NON-NLS-1$
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_after_annotation";//$NON-NLS-1$
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_AFTER_OPENING_BRACE_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_after_opening_brace_in_array_initializer";//$NON-NLS-1$
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_AT_END_OF_FILE_IF_MISSING = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_at_end_of_file_if_missing";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_CATCH_IN_TRY_STATEMENT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_before_catch_in_try_statement";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_CLOSING_BRACE_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_before_closing_brace_in_array_initializer";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_ELSE_IN_IF_STATEMENT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_before_else_in_if_statement";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_FINALLY_IN_TRY_STATEMENT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_before_finally_in_try_statement";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_WHILE_IN_DO_STATEMENT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_before_while_in_do_statement";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ANONYMOUS_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_in_empty_anonymous_type_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_BLOCK = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_in_empty_block"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ENUM_CONSTANT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_in_empty_enum_constant"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ENUM_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_in_empty_enum_declaration";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_METHOD_BODY = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_in_empty_method_body";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_in_empty_type_declaration";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_AND_IN_TYPE_PARAMETER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_and_in_type_parameter"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_ASSIGNMENT_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_assignment_operator"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_AT_IN_ANNOTATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_at_in_annotation"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_AT_IN_ANNOTATION_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_at_in_annotation_type_declaration"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_BINARY_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_binary_operator"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_closing_angle_bracket_in_type_arguments"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_ANGLE_BRACKET_IN_TYPE_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_closing_angle_bracket_in_type_parameters"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_BRACE_IN_BLOCK = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_closing_brace_in_block"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_PAREN_IN_CAST = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_closing_paren_in_cast"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_ASSERT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_colon_in_assert"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_CASE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_colon_in_case";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_CONDITIONAL = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_colon_in_conditional"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_FOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_colon_in_for";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_LABELED_STATEMENT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_colon_in_labeled_statement"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ALLOCATION_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_allocation_expression"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ANNOTATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_annotation"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_array_initializer"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_CONSTRUCTOR_DECLARATION_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_constructor_declaration_parameters"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_CONSTRUCTOR_DECLARATION_THROWS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_constructor_declaration_throws"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ENUM_CONSTANT_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_enum_constant_arguments"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ENUM_DECLARATIONS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_enum_declarations"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_EXPLICIT_CONSTRUCTOR_CALL_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_explicitconstructorcall_arguments"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_FOR_INCREMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_for_increments"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_FOR_INITS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_for_inits"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_DECLARATION_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_method_declaration_parameters"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_DECLARATION_THROWS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_method_declaration_throws"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_INVOCATION_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_method_invocation_arguments"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_MULTIPLE_FIELD_DECLARATIONS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_multiple_field_declarations"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_MULTIPLE_LOCAL_DECLARATIONS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_multiple_local_declarations"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_PARAMETERIZED_TYPE_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_parameterized_type_reference"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_SUPERINTERFACES = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_superinterfaces"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_TYPE_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_type_arguments"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_TYPE_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_comma_in_type_parameters"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_ELLIPSIS  = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_ellipsis";      //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_angle_bracket_in_parameterized_type_reference";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_angle_bracket_in_type_arguments";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_TYPE_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_angle_bracket_in_type_parameters";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACE_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_brace_in_array_initializer";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_bracket_in_array_allocation_expression";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACKET_IN_ARRAY_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_bracket_in_array_reference";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_ANNOTATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_annotation"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CAST = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_cast"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CATCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_catch"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CONSTRUCTOR_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_constructor_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_ENUM_CONSTANT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_enum_constant"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_FOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_for"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_IF = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_if"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_METHOD_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_method_declaration"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_METHOD_INVOCATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_method_invocation"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_PARENTHESIZED_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_parenthesized_expression"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_SWITCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_switch"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_SYNCHRONIZED = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_synchronized"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_WHILE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_opening_paren_in_while"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_POSTFIX_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_postfix_operator"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_PREFIX_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_prefix_operator"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_QUESTION_IN_CONDITIONAL = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_question_in_conditional"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_QUESTION_IN_WILDCARD = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_question_in_wildcard"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_SEMICOLON_IN_FOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_semicolon_in_for"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_AFTER_UNARY_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_after_unary_operator"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_AND_IN_TYPE_PARAMETER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_and_in_type_parameter";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_ASSIGNMENT_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_assignment_operator";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_AT_IN_ANNOTATION_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_at_in_annotation_type_declaration";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_BINARY_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_binary_operator";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_angle_bracket_in_parameterized_type_reference";           //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_angle_bracket_in_type_arguments";               //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_TYPE_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_angle_bracket_in_type_parameters";             //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACE_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_brace_in_array_initializer";         //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_bracket_in_array_allocation_expression";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACKET_IN_ARRAY_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_bracket_in_array_reference";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_ANNOTATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_annotation";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CAST = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_cast";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CATCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_catch"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CONSTRUCTOR_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_constructor_declaration";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_ENUM_CONSTANT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_enum_constant"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_FOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_for";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_IF = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_if";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_METHOD_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_method_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_METHOD_INVOCATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_method_invocation"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_PARENTHESIZED_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_parenthesized_expression"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_SWITCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_switch";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_SYNCHRONIZED = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_synchronized";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_WHILE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_closing_paren_in_while"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_ASSERT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_colon_in_assert";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_CASE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_colon_in_case";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_CONDITIONAL = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_colon_in_conditional";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_DEFAULT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_colon_in_default";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_FOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_colon_in_for";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_LABELED_STATEMENT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_colon_in_labeled_statement"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ALLOCATION_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_allocation_expression"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ANNOTATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_annotation";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_array_initializer"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_CONSTRUCTOR_DECLARATION_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_constructor_declaration_parameters";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_CONSTRUCTOR_DECLARATION_THROWS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_constructor_declaration_throws";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ENUM_CONSTANT_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_enum_constant_arguments";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ENUM_DECLARATIONS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_enum_declarations"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_EXPLICIT_CONSTRUCTOR_CALL_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_explicitconstructorcall_arguments";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_FOR_INCREMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_for_increments";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_FOR_INITS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_for_inits"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_DECLARATION_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_method_declaration_parameters"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_DECLARATION_THROWS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_method_declaration_throws"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_INVOCATION_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_method_invocation_arguments";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_MULTIPLE_FIELD_DECLARATIONS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_multiple_field_declarations";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_MULTIPLE_LOCAL_DECLARATIONS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_multiple_local_declarations";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_PARAMETERIZED_TYPE_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_parameterized_type_reference";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_SUPERINTERFACES = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_superinterfaces";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_TYPE_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_type_arguments";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_TYPE_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_comma_in_type_parameters";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_ELLIPSIS  = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_ellipsis";    //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE  = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_angle_bracket_in_parameterized_type_reference";  //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_angle_bracket_in_type_arguments";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_TYPE_PARAMETERS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_angle_bracket_in_type_parameters";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ANNOTATION_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_annotation_type_declaration";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ANONYMOUS_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_anonymous_type_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_array_initializer"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_BLOCK = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_block"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_CONSTRUCTOR_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_constructor_declaration";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ENUM_CONSTANT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_enum_constant"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ENUM_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_enum_declaration";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_METHOD_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_method_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_SWITCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_switch";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_TYPE_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_brace_in_type_declaration";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_bracket_in_array_allocation_expression";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_bracket_in_array_reference";//$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_TYPE_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_bracket_in_array_type_reference";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANNOTATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_annotation";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANNOTATION_TYPE_MEMBER_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_annotation_type_member_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_CATCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_catch"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_CONSTRUCTOR_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_constructor_declaration";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ENUM_CONSTANT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_enum_constant"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_FOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_for";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_IF = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_if";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_METHOD_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_method_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_METHOD_INVOCATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_method_invocation"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_PARENTHESIZED_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_parenthesized_expression"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_SWITCH = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_switch";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_SYNCHRONIZED = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_synchronized";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_WHILE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_while"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_POSTFIX_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_postfix_operator";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_PREFIX_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_prefix_operator";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_QUESTION_IN_CONDITIONAL = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_question_in_conditional";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_QUESTION_IN_WILDCARD = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_question_in_wildcard"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_SEMICOLON = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_semicolon";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_SEMICOLON_IN_FOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_semicolon_in_for";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BEFORE_UNARY_OPERATOR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_before_unary_operator"; //$NON-NLS-1$
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BETWEEN_BRACKETS_IN_ARRAY_TYPE_REFERENCE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_between_brackets_in_array_type_reference";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_BRACES_IN_ARRAY_INITIALIZER = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_between_empty_braces_in_array_initializer"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_BRACKETS_IN_ARRAY_ALLOCATION_EXPRESSION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_between_empty_brackets_in_array_allocation_expression"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_ANNOTATION_TYPE_MEMBER_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_between_empty_parens_in_annotation_type_member_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_CONSTRUCTOR_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_between_empty_parens_in_constructor_declaration";     //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_ENUM_CONSTANT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_between_empty_parens_in_enum_constant"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_METHOD_DECLARATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_between_empty_parens_in_method_declaration";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see CoreOptionIDs#DO_NOT_INSERT
     */
    public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_METHOD_INVOCATION = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.insert_space_between_empty_parens_in_method_invocation"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_KEEP_ELSE_STATEMENT_ON_SAME_LINE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.keep_else_statement_on_same_line"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_KEEP_EMPTY_ARRAY_INITIALIZER_ON_ONE_LINE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.keep_empty_array_initializer_on_one_line"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_KEEP_GUARDIAN_CLAUSE_ON_ONE_LINE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.format_guardian_clause_on_one_line";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_KEEP_SIMPLE_IF_ON_ONE_LINE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.keep_imple_if_on_one_line"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_KEEP_THEN_STATEMENT_ON_SAME_LINE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.keep_then_statement_on_same_line";//$NON-NLS-1$
     ...
     * </pre>
     */
    public static final String FORMATTER_LINE_SPLIT = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.lineSplit"; //$NON-NLS-1$
     ...
     * </pre>
     */
    public static final String FORMATTER_NUMBER_OF_EMPTY_LINES_TO_PRESERVE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.number_of_empty_lines_to_preserve";   //$NON-NLS-1$
    /**
     * <pre>
     ...
     * @see #FALSE
     */
    public static final String FORMATTER_PUT_EMPTY_STATEMENT_ON_NEW_LINE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.put_empty_statement_on_new_line";       //$NON-NLS-1$
    /**
     * <pre>
     ...
     * 
     * @see CoreOptionIDs#TAB
     * @see CoreOptionIDs#SPACE
     * @see #MIXED
     */
    public static final String FORMATTER_TAB_CHAR = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.tabulation.char"; //$NON-NLS-1$
    /**
     * <pre>
     ...
     * </pre>
     */
    public static final String FORMATTER_TAB_SIZE = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.tabulation.size"; //$NON-NLS-1$
     ...
     *     - default:           FALSE
     * </pre>
     * <p>This is used only if the {@link #FORMATTER_TAB_CHAR } is set to {@link CoreOptionIDs#TAB}.</p>
     * @see #TRUE
     * @see #FALSE
     */
    public static final String FORMATTER_USE_TABS_ONLY_FOR_LEADING_INDENTATIONS = CALEclipseCorePlugin.PLUGIN_ID + ".formatter.use_tabs_only_for_leading_indentations"; //$NON-NLS-1$
    
    // org.openquark.cal.eclipse.core.content.assist.enable.auto.completion
    public static final String AUTO_COMPLETION_TRIGGERS = CALEclipseCorePlugin.PLUGIN_ID + ".content.assist.auto.completion.triggers";      //$NON-NLS-1$
    public static final String ENABLE_AUTO_COMPLETION = CALEclipseCorePlugin.PLUGIN_ID + ".content.assist.enable.auto.completion";      //$NON-NLS-1$
    public static final String ENABLE_INSERT_SINGLE_PROPOSAL_AUTOMATICALLY = CALEclipseCorePlugin.PLUGIN_ID + ".content.assist.enable.insert.single.proposal.automatically";      //$NON-NLS-1$
    public static final String ENABLE_ADD_IMPORT_INSTEAD_OF_QUALIFIED_NAME = CALEclipseCorePlugin.PLUGIN_ID + ".content.assist.enable.add.import.instead.of.qualified.name";      //$NON-NLS-1$
    public static final String ENABLE_FILL_ARGUMENT_NAMES_ON_COMPLETION = CALEclipseCorePlugin.PLUGIN_ID + ".content.assist.enable.fill.argument.names.on.completion";      //$NON-NLS-1$
