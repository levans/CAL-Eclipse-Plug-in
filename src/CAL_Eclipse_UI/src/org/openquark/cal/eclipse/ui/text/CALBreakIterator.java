...
/**
 * A cal break iterator. It returns all breaks, including before and after
 ...
 * @since 3.0
 */
public class CALBreakIterator extends BreakIterator {
    ...
    static final class Whitespace extends Run {
        ...
        protected boolean isValid(char ch) {
            return LanguageInfo.isCALWhitespace(ch) && ch != '\n' && ch != '\r';
        }
    }
    ...
    static final class CamelCaseIdentifier extends Run {
        ...
        private int getKind(char ch) {
            if (!LanguageInfo.isCALVarPart(ch)) {
                return K_INVALID;
            }
    ...
    static final class Other extends Run {
        ...
        @Override
        protected boolean isValid(char ch) {
            return !LanguageInfo.isCALWhitespace(ch) && !LanguageInfo.isCALVarPart(ch);
        }
    }
