...
public final class SearchMessages extends NLS {
    ...
    private static final String BUNDLE_NAME = "org.openquark.cal.eclipse.ui.search.SearchMessages";//$NON-NLS-1$
    ...
    public static String SearchPage_scope_definitions;
    public static String SearchPage_scope_instancesOfType;
    public static String SearchPage_scope_instancesOfClass;
    public static String SearchPage_scope_references_constructions;
    public static String SearchPage_scope_label;
    public static String SearchPage_regularExpression;
    public static String SearchPage_searchingMessage;
    public static String SearchPage_CALSearchMessage;
    public static String SearchPage_initializingTypeInfo;
    public static String CALSearchLabelProvider_count_format;
