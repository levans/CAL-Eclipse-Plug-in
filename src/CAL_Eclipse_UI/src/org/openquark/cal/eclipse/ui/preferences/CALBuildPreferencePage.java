 ...
 * @author Edward Lam
 */
public class CALBuildPreferencePage extends PropertyAndPreferencePage {
    
    public static final String PREF_ID = "org.openquark.cal.eclipse.ui.preferences.CALBuildPreferencePage"; //$NON-NLS-1$
    public static final String PROP_ID = "org.openquark.cal.eclipse.ui.propertyPages.CALBuildPreferencePage"; //$NON-NLS-1$
    
    private CALBuildConfigurationBlock fConfigurationBlock;
    
    public CALBuildPreferencePage() {
    ...
    public void createControl(Composite parent) {
        ...
        fConfigurationBlock = new CALBuildConfigurationBlock(getNewStatusChangedListener(), getProject(), container);
