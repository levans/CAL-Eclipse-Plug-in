 ...
 *******************************************************************************/
/*
 * CALEditorAutoCompletionPage.java
 * Created: Apr 12, 2007
 * By: Greg McClement
 */
...
public class CALEditorContentAssistPage extends PropertyAndPreferencePage {

    public static final String PREF_ID = "org.openquark.cal.eclipse.ui.preferences.ContentAssistPreferencePage"; //$NON-NLS-1$
    public static final String PROP_ID = "org.openquark.cal.eclipse.ui.propertyPages.ContentAssistPreferencePage"; //$NON-NLS-1$

    private CALEditorContentAssistBlock fConfigurationBlock;

    public CALEditorContentAssistPage() {
    ...
    public void createControl(Composite parent) {
        ...
        fConfigurationBlock = new CALEditorContentAssistBlock(getNewStatusChangedListener(), getProject(), container);
