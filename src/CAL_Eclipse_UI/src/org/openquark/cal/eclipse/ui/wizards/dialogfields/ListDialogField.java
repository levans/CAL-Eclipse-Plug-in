...
import org.openquark.cal.eclipse.ui.util.TableLayoutComposite;
    ...
    public List<Object> getSelectedElements() {
        ...
        if (isOkToUse(fTableControl)) {
            ...
            if (selection instanceof IStructuredSelection) {
                for (Iterator<Object> iter = UnsafeCast.unsafeCast(((IStructuredSelection)selection).iterator()); iter.hasNext(); ) {
