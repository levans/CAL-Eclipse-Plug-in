 ...
 *                             /org.eclipse.jdt.ui/ui/org/eclipse/jdt/internal/ui/text/java/JavaDoubleClickSelector.java
 *                           Eclipse source is available at: http://www.eclipse.org/downloads/
 *******************************************************************************/

/*
 * CALDoubleClickSelector.java
 ...
 * @author Edward Lam
 */
public class CALDoubleClickSelector implements ITextDoubleClickStrategy {
    ...
    private static final class AtJavaIdentifierDetector {
        ...
        private final boolean fSelectAnnotations = false;
...
//              offset= anchor - 1; // use to select the previous word when right behind it
    ...
    protected CALPairMatcher fPairMatcher = new CALPairMatcher(BRACKETS);
    protected final AtJavaIdentifierDetector fWordDetector = new AtJavaIdentifierDetector();
    
    
    public CALDoubleClickSelector() {
        super();
    }
