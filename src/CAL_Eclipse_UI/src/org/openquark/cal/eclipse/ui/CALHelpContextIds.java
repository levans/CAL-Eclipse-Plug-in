 ...
 * @author Edward Lam
 */
public class CALHelpContextIds {

    public static final String PREFIX                                         = CALEclipseUIPlugin.PLUGIN_ID + '.';
    ...
    public static final String GENERATE_ELEMENT_COMMENT_ACTION                = PREFIX + "generate_element_comment_action";                       //$NON-NLS-1$
    public static final String CLEAN_IMPORTS_ACTION                           = PREFIX + "clean_imports_action";                                  //$NON-NLS-1$
    public static final String TYPE_DECLARATION_INSERTER_ACTION               = PREFIX + "type_declaration_inserter_action";                      //$NON-NLS-1$
    public static final String PRETTY_PRINTER_ACTION                          = PREFIX + "pretty_printer_action";                                 //$NON-NLS-1$
    ...
    public static final String OPENDECLARATION_ACTION                               = PREFIX + "openDeclaration_action";                                //$NON-NLS-1$
