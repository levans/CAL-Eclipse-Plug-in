...
/*
 * TodoTaskConfigurationBlock.java
...
import org.openquark.cal.eclipse.ui.wizards.dialogfields.IListAdapter;
import org.openquark.cal.eclipse.ui.wizards.dialogfields.ListDialogField;
import org.openquark.cal.eclipse.ui.wizards.dialogfields.SelectionButtonDialogField;
...
public class TodoTaskConfigurationBlock extends OptionsConfigurationBlock {
    ...
    private static final Key PREF_COMPILER_TASK_TAGS = getJDTCoreKey(CoreOptionIDs.COMPILER_TASK_TAGS);
    private static final Key PREF_COMPILER_TASK_PRIORITIES = getJDTCoreKey(CoreOptionIDs.COMPILER_TASK_PRIORITIES);

    private static final Key PREF_COMPILER_TASK_CASE_SENSITIVE = getJDTCoreKey(CoreOptionIDs.COMPILER_TASK_CASE_SENSITIVE);

    private static final String PRIORITY_HIGH = CoreOptionIDs.COMPILER_TASK_PRIORITY_HIGH;
    private static final String PRIORITY_NORMAL = CoreOptionIDs.COMPILER_TASK_PRIORITY_NORMAL;
    private static final String PRIORITY_LOW = CoreOptionIDs.COMPILER_TASK_PRIORITY_LOW;
    ...
    private final ListDialogField fTodoTasksList;
    ...
    public TodoTaskConfigurationBlock(IStatusChangeListener context, IProject project, IWorkbenchPreferenceContainer container) {
        ...
        String[] buttons = new String[]{PreferencesMessages.TodoTaskConfigurationBlock_markers_tasks_add_button,
            PreferencesMessages.TodoTaskConfigurationBlock_markers_tasks_edit_button, PreferencesMessages.TodoTaskConfigurationBlock_markers_tasks_remove_button, null,
    ...
    private void setToDefaultTask(TodoTask task) {
        List<Object> elements = fTodoTasksList.getElements();
    ...
    protected final void updateModel(DialogField field) {
        if (field == fTodoTasksList) {
            ...
            List<Object> list = fTodoTasksList.getElements();
    ...
    private void unpackTodoTasks() {
        ...
        ArrayList<Object> elements = new ArrayList<Object>(tags.length);
