...
/**
 * The template context that is applicable for all CAL files. We make
 * no distinction between CALDoc and CAL locations in the file
 * 
 * @author Andrew Eisenberg
 */
public class CALTemplateContextType extends TemplateContextType {
    public final static String NAME = "CAL";

    public final static String ID = "org.openquark.cal.eclipse.ui.CALTemplateContext";

    public CALTemplateContextType() {
        super();
        addGlobalResolvers();
    }
