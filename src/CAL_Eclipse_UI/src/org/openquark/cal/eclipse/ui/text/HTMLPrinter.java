...
public class HTMLPrinter {
    ...
    public static void insertPageProlog(StringBuilder buffer, int position, RGB bgRGB, URL styleSheetURL) {
    ...
    public static void insertPageProlog(StringBuilder buffer, int position, RGB bgRGB) {
        if (bgRGB == null) {
